(custom-set-variables
 ...
 '(erc-autojoin-channels-alist (quote (("freenode.net" "#haskell" "#emacs-circe" "#emacs" "#lisp"))))
 '(erc-autojoin-mode t)
 ...
 '(exec-path (quote ("~/bin" "/usr/local/bin" "/usr/local/opt/git/share/git-core" "/usr/bin" "/bin" "/usr/local/sbin" "/usr/sbin" "/sbin" "/usr/X11R6/bin" "/usr/share/texmf/bin")))
 '(face-font-family-alternatives (quote (("Onuava" "Consolas" "Verily Serif Mono" "Monaco" "Monospace" "courier" "fixed") ("Monospace" "courier" "fixed") ("courier" "CMU Typewriter Text" "fixed") ("Sans Serif" "helv" "helvetica" "arial" "fixed") ("helv" "helvetica" "arial" "fixed"))))
 '(fill-column 78)
 ...
 '(user-initials "rdp")
 '(user-mail-address "rdparker@gmail.com")
...
(custom-set-faces
 ...
 '(highlight ((t (:background "SkyBlue"))))
 ...
 '(magit-diff-add-face ((((class color) (background dark)) (:foreground "FireBrick"))))
 '(magit-diff-del-face ((((class color) (background dark)) (:foreground "DarkOliveGreen"))))
 ...
 '(whitespace-indentation ((t (:background "#222200" :foreground "firebrick"))))
 '(whitespace-line ((t (:background "gray20"))))
 '(whitespace-space-before-tab ((t (:background "#6b3500"))))
 '(whitespace-trailing ((t (:background "#522222")))))
