...
(custom-theme-set-variables
 ...
 '(face-font-family-alternatives (quote (("Source Code Pro for Powerline" "Source Code Pro" "Onuava" "Verily Serif Mono" "Monaco" "DejaVu Sans Mono" "Liberation Mono" "Monospace" "courier" "fixed")
					 ...
					 ("Source Sans Pro" "Sans Serif" "helv" "helvetica" "arial" "fixed")
					 ("Sans Serif" "helv" "helvetica" "arial" "fixed")
					 ("helv" "helvetica" "arial" "fixed")))))

(custom-theme-set-faces
 'softer-dark
 '(default ((t (:background "#201f1f" :foreground "#e0dedb" :height 120 :family "Source Code Pro for Powerline"))))
 '(bold ((t (:weight bold))))
 ...
 '(fixed-pitch ((t ( :family "Source Code Pro for Powerline"))))
 '(flymake-errline ((t (:underline "Firebrick4"))))
 '(flymake-warnline ((t (:underline "DarkBlue"))))
 '(info-quoted ((t ( :family "Source Code Pro for Powerline"))))
 '(info-menu-header ((((type tty pc)) :underline t :weight bold)
		     (t :weight semibold :inherit variable-pitch :family "Source Sans Pro")))
 '(info-title-4 ((((type tty pc) (class color)) :weight bold)
		 (t :weight semibold :inherit variable-pitch :family "Source Serif Pro")))
 '(magit-log-head-label-tags ((t (:background "LemonChiffon1" :foreground "goldenrod3" :box 1))))
 '(markdown-header-face ((t (:inherit font-lock-function-name-face :weight semibold :family "Source Serif Pro"))))
