		  ...
		  (:eval
		   (let* ((active (powerline-selected-window-active))
			  ...
			  (lhs (list ;; (powerline-raw "%*" nil 'l)
				     (powerline-raw (window-numbering-get-number-string) nil '1)
				     (funcall separator-left mode-line face1)
				     (powerline-raw mode-line-mule-info face1 'l)
				     (powerline-raw mode-line-client face1 '1)
				     (powerline-raw mode-line-modified face1 '1)
				     (powerline-raw mode-line-remote face1 '1)
				     (powerline-raw mode-line-frame-identification face1 '1)
